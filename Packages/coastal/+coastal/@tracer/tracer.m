classdef tracer < coastal.position
    ...
    methods
        function obj = tracer(x,y,z,H,T,h,z_axis_lower,label_x,no_frames,frame_length)
            ...
            obj@coastal.position(super_args{:});
        ...
        function [do_plot,return_position_x,return_position_y,return_position_z,x_array,z_array] = plot_position(obj,t)
            [do_plot,return_position_x,return_position_y,return_position_z] = plot_position@coastal.position(obj,t);                      
            
            for i = 1:obj.no_frames;
                [do_plot_tail,return_position_x_tail,return_position_y_tail,return_position_z_tail] = plot_position@coastal.position(obj,t - (i * obj.frame_length));             
